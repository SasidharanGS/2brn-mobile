...
function buildInsightsSummary(date: string, period: InsightsPeriod): InsightsSummary {
  ...
  return {
    ...
    observed_seconds: 8520 * span, // ≈2h22m of observed block-time per day
    categories: [
      { task_category: 'work', seconds: 4175 * span, pct: 49 },
      { task_category: 'research', seconds: 2130 * span, pct: 25 },
      { task_category: 'communication', seconds: 1278 * span, pct: 15 },
      { task_category: 'play', seconds: 937 * span, pct: 11 },
    ],
    productivity_states: [
      { productivity_state: 'focused', seconds: 3578 * span, pct: 42 },
      { productivity_state: 'productive', seconds: 2386 * span, pct: 28 },
      { productivity_state: 'in-meeting', seconds: 1363 * span, pct: 16 },
      { productivity_state: 'chilling', seconds: 682 * span, pct: 8 },
      { productivity_state: 'distracted', seconds: 511 * span, pct: 6 },
    ],
    top_apps: [
      { app_name: 'VS Code', seconds: 3493 * span, pct: 41 },
      { app_name: 'Chrome', seconds: 2386 * span, pct: 28 },
      { app_name: 'Slack', seconds: 1448 * span, pct: 17 },
      { app_name: 'Zoom', seconds: 1193 * span, pct: 14 },
    ],
    ...
    recurring_activities: [
      { canonical_summary: 'Reviewing pull requests', occurrences: 9, approx_seconds: 540, variant_count: 4 },
      { canonical_summary: 'Reading research papers', occurrences: 6, approx_seconds: 360, variant_count: 3 },
    ],
  }
}
