...
- No custom launcher icon is bundled yet — Expo's default is used. Drop a
  `1024×1024` PNG at `assets/icon.png` and add `"icon": "./assets/icon.png"` under
  `expo` in `app.json` to brand it.
